...
const DescriptionPage = () => {
  ...
  useEffect(() => {
    if (id) {
      console.log('Fetching student count for id:', id);
      fetch(`http://localhost:5001/api/courses/${id}/stats`)
        .then(res => {
  ...
  useEffect(() => {
    if (course && course.sections) setLoading(false)
  }, [course])
                ...
                <Col xs={24} md={18}>
                  ...
                  <Space size="large" className="descpage-meta">
                    ...
                    <Tooltip title="Enrolled" placement="top">
                      <span>
                        <FaUsers /> {studentCount !== null ? studentCount : <Skeleton width={30} />}
                      </span>
                    </Tooltip>
              ...
              <Row gutter={[24, 24]}>
                <Col xs={24} md={14}>
                  <motion.div variants={fadeIn} custom={2}>
                    ...
                    {loading || !course || !course.sections ? (
                      <Skeleton count={3} />
